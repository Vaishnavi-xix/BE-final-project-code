    ...
    return (
        <div>
            ...
            <div className="card-order mt-4">
                ...
                {orders.map((order) => {
                    const { product, quantity, shipping_address, status, delivery_charges, _id: orderId } = order;
                    if (!product) {
                        return null; // Skip rendering if product is null
                    }
                    return (
                        <div className="my-order-card" key={orderId}>
                            <div>
                                <div className="">
                            ...
                            <div>
                                <div className="ps-5 pt-4">
                                    ...
                                    <button onClick={() => handleDeleteOrder(orderId)}>Delete</button>
                                </div>
                            </div>
                        </div>
                    );
